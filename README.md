...
| `madrid_air_quality_Full_Dataset.ipynb` | `data/Madrid air quality full dataset/` | Full ~64M row dataset loaded from local Parquet files |
...
├── madrid_air_quality_Full_Dataset.ipynb     # Notebook — full Parquet dataset
├── requirements.txt                          # Python dependencies
├── README.md                                 # This file
├── project.pdf                               # Assignment instructions
└── data/
    ├── sample_dataset.csv                    # Sample data for development
    └── Madrid air quality full dataset/      # Full dataset (local Parquet files)
```
